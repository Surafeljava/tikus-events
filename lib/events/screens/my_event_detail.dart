                    ...
                    children: [
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(
                              '${eventModel.allSeats - eventModel.reservedSeats}',
                              style: TextStyle(
                                  fontSize: 20.0,
                            ...
                            SpringButton(
                              ...
                              onTap: () {
                                Navigator.of(context).pushNamed(
                                    EventAddUpdate.routeName,
                                    arguments: EventArgument(
                                        edit: true, myEventModel: eventModel));
                              },
                            ),
                            SpringButton(
                              SpringButtonType.OnlyScale,
