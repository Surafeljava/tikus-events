...
class _EventAddUpdateState extends State<EventAddUpdate> {
  ...
  final GlobalKey<ScaffoldMessengerState> _addscaffoldKey =
  ...
  void initState() {
    ...
    seatsReserved =
        widget.args.edit ? widget.args.myEventModel.reservedSeats : 0;
    if (widget.args.edit) {
      ...
      seatsController.text = (widget.args.myEventModel.allSeats -
              widget.args.myEventModel.reservedSeats)
          .toString();
    }
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          widget.args.edit ? 'Editing' : 'Creating',
          style:
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Expanded(
                                  child: Text(
                                      '${begins.day}/${begins.month}/${begins.year}',
                                      style: TextStyle(
                                          fontSize: 17.0,
                        ...
                        SpringButton(
                          ...
                          Container(
                              ...
                              child: Center(
                                child: Text(
                                  widget.args.edit ? 'Update' : 'Create',
                                  style: TextStyle(
                                      fontSize: 22.0,
                                      color: Colors.white,
                          ...
                          onTap: () {
                            if (_formKey.currentState.validate()) {
                              ...
                              MyEventModel event = widget.args.edit
                                  ? MyEventModel(
                                      userId: 0,
                                      eventId: widget.args.myEventModel.eventId,
                                      title: title,
                                      description: desc,
                                      eventCreatedOn: widget
                                          .args.myEventModel.eventCreatedOn,
                                      eventBeginsOn:
                                          "${begins.day}/${begins.month}/${begins.year}",
                                      eventEndsOn:
                                          "${ends.day}/${ends.month}/${ends.year}",
                                      eventDeadline:
                                          "${deadLine.day}/${deadLine.month}/${deadLine.year}",
                                      eventPicture:
                                          widget.args.myEventModel.eventPicture,
                                      allSeats: int.parse(seats),
                                      reservedSeats: widget
                                          .args.myEventModel.reservedSeats)
                                  : MyEventModel(
                                      userId: 0,
                                      title: title,
                                      description: desc,
                              ...
                              if (widget.args.edit) {
                                BlocProvider.of<EventBloc>(context,
                                        listen: false)
                                    .add(EventUpdate(event));
                              } else {
                                BlocProvider.of<EventBloc>(context,
                                        listen: false)
                                    .add(EventCreate(event, _image));
                              }
                            } else {
                              setState(() {
                                _autoValidate = true;
